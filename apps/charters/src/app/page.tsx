        ...
        <section id="destinations" className=" py-24 sm:py-32">
          <Container>
            ...
            <div>
              {/* FIX */}
              <h3>Day Sailors</h3>
              {/* a fun day sail around bosie island  */}
              <h3>Weekend Warriors</h3>

              <h3>Week Long Cruisers</h3>
            </div>
          </Container>
        </section>
...
others. 
                  ...
                  <p className="mt-6">
                    ...
                    experienced and passionate charter captain who has dedicated
                    his life to the seas. Milan&apos;s love for sailing was
                    instilled at a young age when he spent countless hours
                    navigating the open waters alongside his father. From racing
                    sailboats to exploring hidden coves, his youth was a
                    tapestry of thrilling maritime adventures that fueled his
                    lifelong passion for the sea.
                  </p>
                  <p className="mt-8">
                    Milan&apos;s genuine love for hosting friends and family on
                    unforgettable charter trips around the world shines through
                    in every voyage he embarks upon. With an unwavering
                    commitment to providing exceptional service, he ensures that
                    every moment on board is filled with joy, laughter, and
                    unforgettable memories. Whether it&apos;s a relaxing cruise
                    through turquoise waters or an adrenaline-pumping snorkeling
                    excursion, Captain Milan effortlessly creates an atmosphere
                    that blends relaxation and excitement, making him the
                    perfect companion for your nautical escapades.
                  </p>
                  <p className="mt-8">
                    ...
                    voyage is meticulously planned and executed with the highest
                    standards. You can trust Captain Milan to guide you through
                    your charter adventure with unparalleled skill, making your
                    safety his topmost concern, while still providing an
                    exhilarating and unforgettable experience that will leave
                    you longing for more.
                  </p>
                  <p className="mt-8">
                    Experience the magic of the open seas with Captain Milan,
                    where safety, enjoyment, and adventure come together
                    seamlessly. Book your charter trip today and allow Milan to
                    guide you on an extraordinary voyage that will create
