...
const social = [
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/nicercharters',
  ...
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/nicercharters/',
    icon: (props: React.ComponentProps<'svg'>) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
  ...
  {
    name: 'GitHub',
    href: 'https://github.com/mkcy3/nicerapps/tree/main/apps/charters',
    icon: (props: React.ComponentProps<'svg'>) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
